defmodule Market.DataFeed.Level2.OrderBook do
  @moduledoc """
  ...
  """
  def book(book) do
    bid_levels = Market.DataFeed.Level2.OrderBook.bids(book)
    ask_levels = Market.DataFeed.Level2.OrderBook.asks(book)
