...
defmodule Exchange.Binance.Spot do
  @moduledoc """
  Spot markets.
  ...
  use Exchange.Binance, snapshot_endpoint: :spot
...
defmodule Exchange.Binance.Futures do
  @moduledoc """
  Futures markets.
  ...
  use Exchange.Binance, snapshot_endpoint: :futures
...
defmodule Exchange.Binance.Inverse do
  @moduledoc """
  ...
  use Exchange.Binance, snapshot_endpoint: :inverse
