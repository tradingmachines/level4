# tests
For now: you can manually test data feeds for each exchange by opening an interactive
iex session with `iex -S mix` and calling `Markets.start_market` with an appropriate
